...
public:
    static Result<std::string> encodeMessage(MessageType type, 
                                              uint64_t userId,
                                              uint64_t roomId,
                                              const std::string& body);
    
    static Result<Message> decodeMessage(const std::string& packet);
...
public:
    static std::atomic<uint64_t> s_seqCounter;
};
